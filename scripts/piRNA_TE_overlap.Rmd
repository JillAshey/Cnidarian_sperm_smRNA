...
ahya_repeat_counts <- repeat_counts %>%
  mutate(
    Clean_Group = case_when(
...
- 193004 piRNAs overlap with some TE (265966 - 72962 = 193004)
- 46701 piRNAs overlap with genes (119663 - 72962)
- 72962 piRNAs overlap with both TE and genes 
- 193004+46701+72962 = 312667 piRNAs overlapping TEs, genes or both 
- 51826 piRNAs in intergenic space (364493 - 312667)

## Species comparisons

Plot TE overlap types across spp 
```{r}
all_repeat <- rbind(ahya_repeat_counts, nvec_repeat_counts)
...
pirna_repeat_overlap_spp <- ggplot(percent, aes(x = Species, y = Percent, fill = Element)) +
  ...
  scale_fill_manual(values = botanical_greens) +
  scale_y_continuous(
    expand = c(0, 0),
