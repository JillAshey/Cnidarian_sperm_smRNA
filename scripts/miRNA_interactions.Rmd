...
- Ahya: 3852 genes for mRNA binding (4211-359), 1991 genes for 3' UTR binding (2350-359), 359 genes for both binding. 
- Apoc: 2419 genes for mRNA binding (2468-49), 826 genes for 3' UTR binding (875-49), 49 genes for both binding. 
...
bp_plot <- ggplot(df_freq_all, aes(x = interaction_length, y = perc, fill = Species, color = Species)) +
  ...
  theme(
    ...
    legend.text = element_text(face = "italic"), # Keeps the names italicized
    plot.margin = margin(10, 10, 10, 10)
  ); bp_plot
